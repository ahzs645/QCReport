...
/**
 * Experimental: the physical autosampler layout + prep cross-reference, assembled
 * from the HotBlock digestion and/or Labels workbooks. PURE: `entries` are the
 * prep entries ({ key, id, sampleName, prepRole, position, rack:{column,row}, amount, acid, comments }).
 */

const ROLE_LABEL = { blank: "Method Blank", duplicate: "Duplicate", lfmSpike: "Matrix Spike", icv: "ICV" };

export function RackView({ entries = [] }) {
